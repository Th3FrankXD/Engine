...
namespace NHTV
{
	...
	public:
		...
		BaseSprite(const char* a_pTexture, float a_fWidth, float a_fHeight, const NHTV::Vertex* a_vertexData, const glm::vec4& a_v4colour = glm::vec4(1.f, 1.f, 1.f, 1.f));
        BaseSprite( const char* a_pTexture, const glm::vec2& a_v2Size, const glm::vec2& a_v2Origin, const glm::vec4& a_fv4UVCoordinates = glm::vec4( 0.f, 0.f, 1.f, 1.f ), const glm::vec4& a_v4colour = glm::vec4( 1.f, 1.f, 1.f, 1.f ) );
        BaseSprite( const char* a_pTexture, const glm::vec2& a_v2Size, const glm::vec2& a_v2Origin, const NHTV::Rect& rect, const glm::vec4& a_v4colour = glm::vec4( 1.f, 1.f, 1.f, 1.f ) );
        ...
        void	SetUVCoords( const NHTV::Rect& rect );

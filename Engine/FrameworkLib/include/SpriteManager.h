...
namespace NHTV
{
	...
	public:
		...
		//////////////////////////////////////////////////////////////////////////
        unsigned int	AddSprite( const char* a_pTexture, const glm::vec2& a_v2Size, const glm::vec2& a_v2Origin, const glm::vec4& a_vfUVCoords, const glm::vec4& a_v4colour );
        unsigned int	AddSprite( const char* a_pTexture, const glm::vec2& a_v2Size, const glm::vec2& a_v2Origin, const NHTV::Rect& rect, const glm::vec4& a_v4colour );
        ...
        void			SetSpriteUVCoordinates( unsigned int a_uiSpriteID, const glm::vec2& a_minUVCoord, const glm::vec2& a_maxUVCoord );
		...
		void			SetSpriteColour(unsigned int a_uiSpriteID, const glm::vec4& a_v4Colour);
		void			GetSpriteColour(unsigned int a_uiSpriteID, glm::vec4& a_v4Colour);
		void			SetSpriteScale(unsigned int a_uiSpriteID, const glm::vec2& a_v2SpriteScale);

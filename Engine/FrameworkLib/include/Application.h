...
#pragma region SColor structure to describe a colour
	...
	**/
	struct SColour
	{
		...
		/// @param g unsigned char to represent the green component of an SColour object
		/// @param b unsigned char to represent the blue component of an SColour object
		/// @param a unsigned char to represent the alpha component of an SColour object
...
#pragma region Sprite creation and mainpulation functionality
        ...
        /// Get shader ID for sprite batch (for internal use only).
        GLuint GetSpriteBatchShader() const;
        ...
        unsigned int    CreateSprite( const char* a_pTextureName, const NHTV::Rect& rect, const glm::vec2& a_origin = glm::vec2( 0.0f, 0.0f ), const glm::vec2& a_scale = glm::vec2( 1.0f, 1.0f ), const SColour& a_colour = SColour( 0xFF, 0xFF, 0xFF, 0xFF ) );
        ...
        void			SetSpriteUVCoordinates( unsigned int a_uiSpriteID, const NHTV::Rect& rect );
...
#pragma region Font Rendering functionality
		...
		void			DrawString(const char* a_pText, int a_iXPos, int a_iYPos, float fSize = 1.0f, SColour a_sColour = SColour(0xFF,0xFF,0xFF,0xFF) );
...
#pragma endregion
	...
	private:
		...
		//with
		GLuint m_ShaderID = 0;
        GLuint m_SpriteBatchShaderID = 0;

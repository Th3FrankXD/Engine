		...
		const char* a_szTessellationControlShader /* = nullptr */, const char* a_szTessellationEvaluationShader /* = nullptr */)
{
	...
	const char* vsSource = fileToBuffer(a_szVertexShader);
	const char* fsSource = fileToBuffer(a_szPixelShader);
	const char* gsSource = a_szGeometryShader == nullptr ? nullptr : fileToBuffer(a_szGeometryShader);
	const char* tcsSource = a_szTessellationControlShader == nullptr ? nullptr : fileToBuffer(a_szTessellationControlShader);
	const char* tesSource = a_szTessellationEvaluationShader == nullptr ? nullptr : fileToBuffer(a_szTessellationEvaluationShader);
...
std::string NHTV::GetStringResource( const std::string& type, int ID )
{
	...
	const char* a_szTessellationControlShader /* = nullptr */, const char* a_szTessellationEvaluationShader /* = nullptr */)
{
	...
	char acLog[256];
	// load files into char buffers
	const char* vsSource = a_szVertexShader;
	const char* fsSource = a_szPixelShader;
	const char* gsSource = a_szGeometryShader == nullptr ? nullptr : a_szGeometryShader;
	const char* tcsSource = a_szTessellationControlShader == nullptr ? nullptr : a_szTessellationControlShader;
	const char* tesSource = a_szTessellationEvaluationShader == nullptr ? nullptr : a_szTessellationEvaluationShader;
...
bool Utility::compileShader(const unsigned int a_shaderHandle, const char* a_shaderSrc )
{
	int iSuccess;
	glShaderSource(a_shaderHandle, 1, &a_shaderSrc, 0);

...
namespace NHTV
{
	...
	//////////////////////////////////////////////////////////////////////////
	unsigned int SpriteManager::AddSprite(const char* a_pTexture, const glm::vec2& a_v2Size, const glm::vec2& a_v2Origin, const glm::vec4& a_vfUVCoords, const glm::vec4& a_v4colour)
	{
    ...
    unsigned int SpriteManager::AddSprite( const char* a_pTexture, const glm::vec2& a_v2Size, const glm::vec2& a_v2Origin, const NHTV::Rect& rect, const glm::vec4& a_v4colour )
    {
        BaseSprite* pBasicSprite = new BaseSprite( a_pTexture, a_v2Size, a_v2Origin, rect, a_v4colour );
        if ( m_Sprites.size() > 0 )
        {
            std::vector< BaseSprite* >::iterator sprite_iter = m_Sprites.begin();
            for ( unsigned int i = 0; sprite_iter != m_Sprites.end(); ++sprite_iter, ++i )
	...
	////////////////////////////////////////////////////////////////////////////
	void SpriteManager::SetSpriteUVCoordinates(unsigned int a_uiSpriteID, const glm::vec2& a_minUVCoord, const glm::vec2& a_maxUVCoord)
	{
		BaseSprite* pBasicSprite = m_Sprites[a_uiSpriteID];
		if (pBasicSprite != NULL)
		{
    ...
    void SpriteManager::SetSpriteUVCoordinates( unsigned int a_uiSpriteID, const NHTV::Rect& rect )
    {
        BaseSprite* pBasicSprite = m_Sprites[a_uiSpriteID];
        if ( pBasicSprite != NULL )
        {
            pBasicSprite->SetUVCoords( rect );
        }
    }
	...
	////////////////////////////////////////////////////////////////////////////
	void SpriteManager::SetSpriteColour(unsigned int a_uiSpriteID, const glm::vec4& a_v4Colour)
	{
		BaseSprite* pBasicSprite = m_Sprites[a_uiSpriteID];
		if (pBasicSprite != NULL)
		{
	...
	//////////////////////////////////////////////////////////////////////////
	void SpriteManager::SetSpriteScale(unsigned int a_uiSpriteID, const glm::vec2& a_v2SpriteScale)
	{
		BaseSprite* pBasicSprite = m_Sprites[a_uiSpriteID];
		if (pBasicSprite != NULL)
		{
